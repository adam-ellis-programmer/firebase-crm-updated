    ...
    <div className="page-container-home">
      ...
      <section className="hero-section">
        <div className="hero-content">
          ...
          {!loggedIn ? (
            ...
            <div className="hero-cta">
              <Link to={`/data/${loggedInUser?.uid}`} className="btn btn-primary">
      ...
      <section className="features-section">
        ...
        <div className="features-grid">
          <div className="feature-card">
            ...
            <p>
              Transform your customer data into actionable insights with powerful
              analytics
            </p>
          </div>
          ...
          <div className="feature-card">
            ...
            <p>Never miss a follow-up with integrated task tracking and reminders</p>
          </div>
          ...
          <div className="feature-card">
            ...
            <p>Seamlessly work together with role-based access and shared workspaces</p>
          </div>
          ...
          <div className="feature-card">
            ...
            <p>Store and access all customer-related documents in one secure location</p>
          </div>
        </div>
      </section>
      ...
      <section className="stats-section">
        <div className="stat-item">
          ...
          <span className="stat-description">Increase in team productivity</span>
        </div>
        ...
        <div className="stat-item">
          ...
          <span className="stat-description">Less time on administrative tasks</span>
        </div>
      </section>
      ...
      <section className="testimonial-section">
        ...
        <div className="testimonial-card">
          <div className="testimonial-content">
            ...
            <p>
              This CRM has transformed how our sales team operates. We've seen a dramatic
              increase in conversions and the insights help us make better decisions
              daily.
            </p>
